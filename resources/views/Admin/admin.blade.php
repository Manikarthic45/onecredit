...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <a href="create"><button class="btn btn-primary" style="float:right">CREATE ADMIN</h4></button></a>
            <br>
            <br>
            <br>
                            ...
                            <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">{{ucfirst($data->username)}}</td>
                                        <td align="center">{{$data->email}}</td>
                                        <td class="text-center">{{$data->phone_number}}</td>
                                        <td class="text-center">
                                            <div class="actions">
                                                <a href="edit_admin{{$data->id}}" class="btn btn-sm bg-danger-light me-2"><i class="fa fa-edit"></i></a>
