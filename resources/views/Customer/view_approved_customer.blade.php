                                                ...
                                                <div class="row gy-4">
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="prcode" value="{{$get_customer_details->customer_name}}" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-xxl-6 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="productname" value="{{$get_customer_details->email}}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="stock" value="{{ $get_customer_details->residential_address}}" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="size" value="{{$get_customer_details->permanent_address }}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="unit" value="{{ $get_customer_details->mobile_number }}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="unit" value="{{ $get_customer_details->alternate_mobile_number }}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <img src="public/{{$get_customer_details->profile_photo}}" style="width:200px; height:100px;" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="unit" value="{{ $get_customer_details->profession }}" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="unit" value="{{ $get_customer_details->father_name }}" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="unit" value="{{ $get_customer_details->martial_status }}" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="unit" value="{{ $get_customer_details->aadhar_card }}" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="unit" value="{{ $get_customer_details->pan_card }}" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
