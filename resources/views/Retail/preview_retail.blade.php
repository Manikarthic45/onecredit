            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">VIEW RETAIL</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                                ...
                                                <div class="row gy-4">
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" name="user_name" value="{{$get_retail_details->user_name}}" readonly>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    ...
                                                    <div class="col-xxl-6 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" autocomplete="off" name="shop_name" value="{{$get_retail_details->shop_name}}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" autocomplete="off" name="shop_address" value="{{ $get_retail_details->shop_address}}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" autocomplete="off" name="no_of_branches" value="{{$get_retail_details->no_of_branches }}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" autocomplete="off" name="mobile_number" value="{{ $get_retail_details->mobile_number }}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" autocomplete="off" name="alternate_mobile_number" value="{{ $get_retail_details->alternate_mobile_number }}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" autocomplete="off" name="shop_ownership" value="{{ $get_retail_details->shop_ownership }}" readonly>
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" autocomplete="off" name="gst" value="{{ $get_retail_details->gst }}" readonly>
