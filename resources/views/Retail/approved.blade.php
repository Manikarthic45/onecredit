            ...
            <div class="row">
                <div class="col-8">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">RETAIL APPROVED LIST</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Retail Id</th>
                                        ...
                                        <th class="text-center">Shop Ownership</th>
                                ...
                                <tbody>
                                    ...
                                    $sno = 0;
                                    ?>
                                    @foreach ($retail_approved as $data)
                                    <?php
                                    $sno += 1;
                                    ?>
                                    <tr>
                                        <td align="center">{{$sno}}</td>
                                        <td align="center">{{$data->retail_id}}</td>
                                        <td align="center">{{$data->user_name}}</td>
                                        <td class="text-center">{{$data->shop_name}}</td>
                                        <td class="text-center">{{$data->shop_address}}</td>
                                        <td class="text-center">{{$data->no_of_branches}}</td>
                                        <td class="text-center">{{$data->mobile_number}}</td>
                                        <td class="text-center">{{$data->alternate_mobile_number}}</td>
                                        <td class="text-center">{{$data->shop_ownership}}</td>
                                        <td class="text-center">{{$data->gst}}</td>
                                        <td class="text-center">
                                            <div class="actions">
                                                <a href="edit_approved_retail{{$data->id}}" class="btn btn-sm bg-danger-light me-2"><i class="fa fa-edit"></i></a>
