            ...
            <div class="row">
                <div class="col-8">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">RETAIL REJECTED LIST</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-body">
                            <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $sno = 0;
                                    ?>
                                    @foreach ($retail_rejected as $data)
                                    <?php
                                    $sno += 1;
                                    ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="actions">
                                                <a href="preview_retail{{$data->id}}" class="btn btn-sm bg-danger-light me-2"><i class="fa fa-eye"></i></a>
