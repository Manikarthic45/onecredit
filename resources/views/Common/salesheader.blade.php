...
<div id="layout-wrapper">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        <a href="Dashboard" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="assets/front/images/logo-sm.png" alt="" height="42">
                                </span>
                            <span class="logo-lg">
                                    <img src="assets/front/images/logo-dark.png" alt="" height="42">
                                </span>
                        </a>
                        ...
                        <a href="Dashboard" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                    <img src="assets/front/images/logo-light.png" alt="" height="42">
                                </span>
                        </a>
                    </div>
                            ...
                            <div class="dropdown-head bg-primary bg-pattern rounded-top">
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h6 class="m-0 fs-16 fw-semibold text-white"> Sub Admin List </h6>
                                        </div>
                            ...
                            <div class="tab-content position-relative" id="notificationItemsTabContent">
                                <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                <img src="assets/front/images/users/avatar-2.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                <img src="assets/front/images/users/avatar-8.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                                ...
                                <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        <div class="text-reset notification-item d-block dropdown-item">
                                            <div class="d-flex">
                                                <img src="assets/front/images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item">
                                            <div class="d-flex">
                                                <img src="assets/front/images/users/avatar-6.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                        ...
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">Admin
                                        </span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mt-2 text-center">
                        <img src="assets/front/images/logo-light.png">
                        <div class="dtr-modal-content">
                            <h2>Details for 01 VLZ-452</h2>
    ...
    <div class="app-menu navbar-menu border-end">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="Dashboard" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="assets/front/images/logo-sm.png" alt="" height="45">
                    </span>
                <span class="logo-lg">
                        <img src="assets/front/images/logo-dark.png" alt="" height="45">
                    </span>
            </a>
            <!-- Light Logo-->
            <a href="Dashboard" class="logo logo-light">
                ...
                <span class="logo-lg">
                        <img src="assets/front/images/logo-light.png" alt="" height="45">
                    </span>
            </a>
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="customer">
                            <i class="ri-account-circle-line"></i> <span data-key="t-apps">Customer</span>
                        </a>
