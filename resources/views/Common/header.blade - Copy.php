...
<head>
    ...
    <script>
        WebFont.load({
            google: {"families": ["Tahoma:300,400,700,900"]},
            custom: {
...
<div class="wrapper" >
    <div class="main-header" style=" margin-left: 0;">
        <div class="logo-header" data-background-color="white">
            <a href="" class="logo">
                <img src="assets/assets/images/logo/logo.png" width="100" height="50" alt="navbar brand"
                     class="navbar-brand">
            </a>
        ...
        <nav class="navbar navbar-header navbar-expand-lg" style="background-color: darkorchid;">
                    ...
                    <!-- <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{url('/adminlist')}}">Admin List</a>
                            </div>
                        </div>
                    </li> -->
                    <li class="nav-item">
    ...
    <div class="sidebar sidebar-style-2" style="background-color: darkorchid;">
                ...
                <ul class="nav nav-info">
                    ...
                    <li class="nav-item  @if(\request()->segment(1) == 'banner'
                        ...
                        <a href="{{url('banner')}}" class="link">
                            <p><strong><font color="white">Banner</font></strong></p>
                        </a>
                    </li>
                    <li class="nav-item  @if(\request()->segment(1) == 'about'
                       ...
                       <a href="{{url('about')}}" class="link">
                            <p><strong><font color="white">About Us</font></strong></p>
                        </a>
                    </li>
                                            <li class="nav-item  @if(\request()->segment(1) == 'contacts'
                                                ...
                                                <a href="{{url('contacts')}}" class="link">
                                                    <p><strong><font color="white">Contact</font></strong> </p>
                                                </a>
                                            </li>
                    <li class="nav-item  @if(\request()->segment(1) == 'customer'
                        ...
                        <a href="customer" class="link">
                            <p><strong><font color="white">Customer</font></strong></p>
                        </a>
                    </li>


                    <li class="nav-section">
                        <h4 class="text-section"><strong><font color="white">PRODUCT MASTER</font></strong></h4>
                    </li>
                    <li class="nav-item  @if(\request()->segment(1) == 'maincat'
                        ...
                        <a href="{{url('maincat')}}" class="link">
                            <p><strong><font color="white">Category</font></strong></p>
                        </a>
                    </li>
                    <li class="nav-item  @if(\request()->segment(1) == 'category'
                        ...
                        <a href="{{url('category')}}" class="link">
                            <p><strong><font color="white">SubCategory</font></strong></p>
                        </a>
                    </li>
                    <li class="nav-item  @if(\request()->segment(1) == 'plant'
                        ...
                        <a href="{{url('plant')}}" class="link">
                            <p><strong><font color="white">Products</font></strong></p>
                        </a>
                    </li>
                    <li class="nav-item  @if(\request()->segment(1) == 'events'
                        ...
                        <a href="{{url('events')}}" class="link">
                            <p><strong><font color="white">Blog</font></strong></p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item  @if(\request()->segment(1) == 'order'
                        ...
                        <a href="{{url('order')}}" class="link">
                            <p><strong><font color="white">Order</font></strong></p>
                        </a>
                    </li>
                    <li class="nav-item  @if(\request()->segment(1) == 'invoice'
                        ...
                        <a href="{{url('invoice')}}" class="link">
                            <p><strong><font color="white">Invoice</font></strong></p>
                        </a>
                    </li>
                    <li class="nav-item  @if(\request()->segment(1) == 'payment'
                        ...
                        <a href="{{url('payment')}}" class="link">
                            <p><strong><font color="white">Payment Details</font></strong></p>
                        </a>
                    </li>
...
<div class="modal fade schedule-details design-modal" id="confirmpopup" tabindex="-1" role="dialog"
            ...
            <div class="row">
                <div class="col-md-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required placeholder="Enter Employee Code"
                               name="admincode" id="admincode" value="{{$username}}" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Password</label>
                        <input type="password" class="form-control" required placeholder="Enter Password" name="pw"
                               id="pw" value="{{$password}}" autocomplete="off">
                    </div>
                    <div class="col-md-12" align="center">
                        <button type="" id="updatebtn" class="btn btn-success">Update</button>
                    </div>
                    <div class="col-md-12" align="center">
                        <input type="hidden" class="form-control" required placeholder="Enter Employee Code"
                               name="adminid" id="adminid" value="{{$adminid}}" autocomplete="off">
                        <button type=""></button>
                    </div>
                </div>
            </div>
...
<div class="modal fade schedule-details design-modal" id="success" tabindex="-1" role="dialog"
     aria-labelledby="exampleModalLabel" aria-hidden="true">
