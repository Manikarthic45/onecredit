                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                @if($shipcnt>0)
                                <button type="button" onclick="btnship();" class="btn btn-primary">UPDATE SHIPPING ADDRESS</button>
                                @else
                                <button type="button" onclick="btnship();" class="btn btn-primary">ADD SHIPPING ADDRESS</button>
                                @endif
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-quantity"><span>{{$cat->qty}}</span>
                                            {{--<input type="text" style="width: 80px;height: 50px;" name="" id="{{$cat->productcode}}" value="{{$cat->qty}}" onchange="chgval(this.value,this.id);" onclick="getid(this.id);"/>--}}
                                        </td>
                                        <td class="pro-subtotal"><span>{{$cat->totprice}}</span></td>
                                        <td class="pro-remove"><i class="fa fa-trash" aria-hidden="true" style="color: red;" id="{{$cat->pid}}" onclick="greeting(this.id)"></i></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
